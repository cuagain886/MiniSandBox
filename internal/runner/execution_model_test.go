...
func TestExecutionAllowsOnlyDocumentedEdges(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "pending explicit cancel", from: ExecutionPending, to: ExecutionCancelled, reason: TerminationExplicitCancel},
		{name: "pending disconnect", from: ExecutionPending, to: ExecutionCancelled, reason: TerminationForegroundDisconnect},
		{name: "pending shutdown", from: ExecutionPending, to: ExecutionCancelled, reason: TerminationRunnerShutdown},
